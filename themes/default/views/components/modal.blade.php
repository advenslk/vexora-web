...
<div x-data="{ open: {{ $open ? 'true' : 'false' }} }">
    <template x-teleport="body">
        <div class="fixed inset-0 z-30 flex items-center justify-center overflow-hidden bg-black/50"
            x-show="open">
            <!-- Modal inner -->
            <div class="vexora-card mx-2 mb-8 mt-8 max-h-[calc(100%-theme('spacing.8'))] w-full overflow-y-auto px-6 py-5 text-left md:mx-auto {{ $width }}" x-cloak
                ...
                <div class="flex justify-between items-center">
                    ...
                    @if ($closable && !$closeTrigger)
                        <button @click="open = false" class="text-base/70 hover:text-base">
