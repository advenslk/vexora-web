...
class Index extends Component
{
    ...
    public function render()
    {
        return view('products.index')->layoutData([
            ...
            'description' => strip_tags($this->category->description ?: 'Order ' . $this->category->name . ' from Vexora Cloud, founded by Ayush Kumar Jha. Premium hosting with NVMe storage, DDoS-protected infrastructure and real Paymenter checkout.'),
