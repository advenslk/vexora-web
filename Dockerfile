...
RUN apk add --no-cache --update ca-certificates curl git supervisor tar unzip nginx libpng-dev libxml2-dev libzip-dev icu-dev autoconf make g++ gcc libc-dev linux-headers gmp-dev netcat-openbsd \
